...
(lib.reflect_mask_2447501 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,204,255,0.502)").s().p("");
	this.shape.setTransform(0.025,0.0022);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask_2447501, new cjs.Rectangle(-96.1,-103.2,192.3,206.5), null);
...
(lib.reflect = function(mode,startPosition,loop) {
	...
	this.lighter_tgt.setTransform(0,-169.65,0.682,0.682,0,0,-20.0004);
	this.lighter_tgt.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-239.6,192.3,479.2), null);


(lib.reflect_container_cjs_2447501 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.5,342.95,1,1,0,0,0,-0.5,0.1);
	this.instance.compositeOperation = "lighter";
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regY:-0.1,y:-0.1},9,cjs.Ease.get(-1)).to({regY:0.1,y:-342.75},9,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-582.4,192.3,1164.8);
...
(lib.reflect_wrapper_2447501 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// cjs
	this.reflect = new lib.reflect_container_cjs_2447501();
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_2447501, new cjs.Rectangle(0,-239.6,192.3,479.2), null);
...
(lib.sign_effect_2447501 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(423,598.65,0.9209,0.9209);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.parent = this;
	this.instance_1.setTransform(586.35,415.95,0.9209,0.9209);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.parent = this;
	this.instance_2.setTransform(474.85,519.35,0.9209,0.9209);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(479,430.15,0.6674,0.6674);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(581.1,599.05,0.6376,0.6376);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(556.05,521.15,0.6077,0.6077);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(423,477.15,0.9209,0.9209);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.parent = this;
	this.instance_7.setTransform(530.55,460.1,0.9209,0.9209);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// mask_idn
	this.reflect_mask = new lib.reflect_mask_2447501();
	this.reflect_mask.name = "reflect_mask";
	this.reflect_mask.parent = this;
	this.reflect_mask.setTransform(507.1,507);
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(301.625,305.126);

	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_2447501();
	this.reflect_wrapper.name = "reflect_wrapper";
	this.reflect_wrapper.parent = this;
	this.reflect_wrapper.setTransform(410.95,507);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_2447501, new cjs.Rectangle(32,162.1,606,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_2447501();
...
// stage content:
(lib._2447501_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(319,373.3,1,1,0,0,0,319,373.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(691.4,667.4,-53.39999999999998,79.20000000000005);
// library properties:
lib.properties = {
	id: '_2447501_sign_effect',
	width: 640,
	height: 800,
	fps: 18,
	color: "#333333",
...
an.compositions['_2447501_sign_effect'] = {
